...
const Footer = () => {
  return (
    <div
      className="flex flex-col p-8 mt-8"
      style={{
    ...
    >
      <div
        className="flex pb-10 text-base gap-36"
        style={{
          borderBottom: "1px solid #777777",
        }}
      >
        <ul className="flex flex-col w-32 gap-3">
      ...
      <p className="pt-10 mb-6 text-xs">© 2025 Spotify AB</p>
